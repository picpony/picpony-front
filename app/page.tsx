...
async function getImages(): Promise<ApiResponse> {
  const res = await fetch(
    "https://trixiebooru.org/api/v1/json/search/images?q=-explicit%2C%20-questionable%2C%20-suggestive%2C%20-grotesque%2C%20-grimdark%2C%20-spoiler%2C%20pony&page=1&per_page=50&sf=created_at&sd=desc",
    { 
      next: { revalidate: 60 },
      headers: {
...
export default async function Home() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <h1 className="text-3xl font-bold text-gray-900 mb-8">最新图片</h1>
