        ...
        <div className="p-6 pt-4">
          <div 
            className={`border-2 border-dashed rounded-xl p-6 flex flex-col items-center justify-center text-center cursor-pointer transition-colors mb-6 ${
              selectedImage ? 'border-primary/50 bg-primary/5' : 'border-slate-300 hover:border-primary hover:bg-slate-50'
            }`}
          ...
          >
            ...
            {selectedImage ? (
              ...
              <>
                <MdCloudUpload size={48} className="text-slate-400 mb-3" />
                <p className="text-slate-700 font-medium mb-1">点击或拖拽图片到此处</p>
              </>
            )}
          </div>
          ...
          <div className="mb-6 px-2">
            <div className="flex justify-between items-center mb-2">
              <label className="text-sm font-medium text-slate-700">容差</label>
